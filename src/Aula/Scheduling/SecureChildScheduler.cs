...
public class SecureChildScheduler : IChildScheduler
{
	...
	public async Task<int> ScheduleTaskAsync(Child child, string taskName, string cronExpression, string? description = null)
	{
	...
	public async Task<bool> CancelTaskAsync(Child child, int taskId)
	{
		if (child == null) throw new ArgumentNullException(nameof(child));
	...
	public async Task<List<ChildScheduledTask>> GetScheduledTasksAsync(Child child)
	{
		if (child == null) throw new ArgumentNullException(nameof(child));
	...
	public async Task<bool> SetTaskEnabledAsync(Child child, int taskId, bool enabled)
	{
		if (child == null) throw new ArgumentNullException(nameof(child));
